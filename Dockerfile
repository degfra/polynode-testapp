...
##   $ docker build -t node-js-for-degfra-polynode-testapp .
##
## RUNNING
##   $ docker run -p 3000:3000 node-js-for-degfra-polynode-testapp
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="v75ah4j" \
    STACKSMITH_STACK_NAME="Node.js for degfra/polynode-testapp" \
